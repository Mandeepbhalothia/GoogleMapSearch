...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    private PlacesAutoCompleteAdapter.ClickListener clickListener;
    ...
    public void setClickListener(PlacesAutoCompleteAdapter.ClickListener clickListener) {
        ...
        if (autocompletePredictions.isSuccessful()) {
            ...
            if (findAutocompletePredictionsResponse != null)
                for (AutocompletePrediction prediction : findAutocompletePredictionsResponse.getAutocompletePredictions()) {
                    ...
                    resultList.add(new PlacesAutoCompleteAdapter.PlaceAutocomplete(prediction.getPlaceId(), prediction.getPrimaryText(STYLE_NORMAL).toString(), prediction.getFullText(STYLE_BOLD).toString()));
                }
    ...
    @NonNull
    @Override
    public PlacesAutoCompleteAdapter.PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View convertView = layoutInflater.inflate(R.layout.place_recycler_item_layout, viewGroup, false);
        return new PlacesAutoCompleteAdapter.PredictionHolder(convertView);
    }

    @Override
    public void onBindViewHolder(@NonNull PlacesAutoCompleteAdapter.PredictionHolder mPredictionHolder, final int i) {
